...
assign exu_info.alu_op.a = JAL || JALR || AUIPC ? issue_info.data.pc : LUI ? 0 : src.d[0];
wire [31:0]b0 = I || L || AUIPC || S  || LUI ? issue_info.data.imm : JAL || JALR ? 32'b100 :
        CSR && f001 ? 32'b0 : CSR && f010 ? csr_rdata.r1 : src.d[1];
...
assign exu_info.upc = (CSR && f000) ? csr_rdata.upc : (JALR ? src.d[0] : issue_info.data.pc);
