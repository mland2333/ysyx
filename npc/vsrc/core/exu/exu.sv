...
module ysyx_24110006_EXU (
  ...
  assign is_branch_inst = exu_info.branch_info.jal || exu_info.branch_info.jalr || exu_info.branch_info.branch;
  ...
  assign wb_result.flush = is_branch_inst && (taken ^ exu_info.bp_info.pred_taken || pred_err);
