...
module ysyx_24110006_ROB #(
  ...
  assign rq2.pop = pop && valid[rq2.pop_index] && !(two_store || first_branch || second_branch);
  ...
  logic two_store, first_branch, second_branch;
  assign two_store = inst1.type_store && inst2.type_store;
  assign first_branch = result[rq1.pop_index].jal || result[rq1.pop_index].jalr || result[rq1.pop_index].branch;
  assign second_branch = result[rq2.pop_index].jal || result[rq2.pop_index].jalr || result[rq2.pop_index].branch;
